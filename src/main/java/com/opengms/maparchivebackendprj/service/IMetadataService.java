...
public interface IMetadataService {
     ...
     * @Author bin
     **/
    Map<String, Object> getMetadataByFilenameByType(String filename, MapClassification mapCLS, String excelPath);

    JsonResult getMetadataByExcel(ExcelPathDTO excelPathDTO);

    JsonResult getMetadata(SpecificFindDTO findDTO, MapClassification mapCLS);
}
